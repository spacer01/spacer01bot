...
MY_CONSUMER_SECRET = 'YjPUuxuXrSAVIdPeKW6lnlOkHOn9jzmor5yCgKMOgm5JlzAix8x'
...
SOURCE_ACCOUNTS = ["spacer01"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
